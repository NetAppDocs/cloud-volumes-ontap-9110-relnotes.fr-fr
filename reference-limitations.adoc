...
https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-backup-to-cloud.html["Découvrez comment utiliser Cloud Backup Service pour sauvegarder et restaurer des données ONTAP"^].
